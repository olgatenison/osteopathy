const navigation = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/ruslan.hulisevskyi",
    icon: (props) => (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/hulisevskyi/",
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
    ...
    <footer className="bg-[#d6d8d5]">
      <div className="mx-auto max-w-7xl px-6 py-12 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <p className="mt-8 text-center text-sm/6 text-gray-600 md:order-1 md:mt-0">
          &copy; 2026 Остеопат Руслан Гулишевский. Все права защищены.{" "}
          <a
